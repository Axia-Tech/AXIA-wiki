...
burned. That amount is 0.01 in AXIALunar, so it's recommended to keep at least 0.1 KSM in your account
...
[Polkascan](https://polkascan.io/pre/axialunar). Also, you can verify the bonding state under the
