...
in AXIASolar and AXIALunar. The other two bodies are the
...
["Democracy" tab of AXIASolar Apps](https://axiasolar.js.org/apps/#/democracy/). Any active referendum
...
Navigate to the "Extrinsics" tab on AXIASolar Apps and select the options "democracy" and "delegate".
...
The easiest way to do this is from the "Extrinsics" tab of AXIASolar Apps. Select the "democracy"
