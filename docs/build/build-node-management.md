...
This page contains basic information about running a Parity AXIASolar client. There are a lot of ways
...
The Parity AXIASolar client implements a [AXIASolar Host](../learn/learn-axiasolar-host.md) and a native
...
Parity's AXIASolar client has two Wasm execution methods, interpreted (default) and compiled. Set the
...
The Parity AXIASolar client connects to telemetry by default. You can disable it with
