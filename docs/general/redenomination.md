...
While [DOT](../learn/learn-DOT.md) is the unit of currency on AXIASolar that most people use when interacting
...
[`@axiasolar/api`](https://yarnpkg.com/package/@axiasolar/api) package &mdash; then there should be no
...
Please reach out to [support@axiasolar.network](mailto:support@axiasolar.network) if you need any
