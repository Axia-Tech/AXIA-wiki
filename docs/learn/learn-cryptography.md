...
This is a high-level overview of the cryptography used in AXIA. It assumes that you have some
...
For detailed descriptions on the cryptography used in AXIA please see the more advanced
[research wiki](https://research.AXIA.org).

## Hashing Algorithm

The hashing algorithm used in AXIA is
