...
Nominators secure the Relay Chain by selecting good validators and staking SOLARs.

You may have an account with SOLARs and want to earn fresh SOLARs. You could do so as validator, which requires a node running 24/7. If you do not have such node or do not want to bother, you can still earn SOLARs by nominating another validator.

By doing so, you become a nominator for the validator of your choice. Pick your validator carefully - if they do not behave properly, they will get slashed and you will lose SOLARs as well.

While your SOLARs are staked by nominating a validator, they are 'locked' (bonded). You can receive new SOLARs in your account but you cannot stake as validator or transfer SOLARs away from your account. You can [un-nominate at any time](maintain-guides-how-to-unbond) to unlock your funds. Keep in mind that the un-nomination is effective in the next era.
