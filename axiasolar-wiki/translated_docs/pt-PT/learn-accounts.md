...
The deposit function in JavaScript is defined below, cribbed from the [Rust source](https://github.com/paritytech/axiasolar/blob/master/runtime/axialunar/src/constants.rs#L26).
