...
- [Path of a Parachain Block](https://axiacoin.network/the-path-of-a-parachain-block/) - Article by Axia analyst Joe Petrowski expounding on the validity checks that a parachain block must pass in order to progress the parachain.
